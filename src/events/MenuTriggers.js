...
function onMenuFormatRange(e) {
    ...
    try {
        const result = Common.Modules.JsonStudio.beautifyActiveRange(activeSpreadsheet, 2);
...
function onMenuMinifyRange(e) {
    ...
    const activeSpreadsheet = SpreadsheetApp.getActiveSpreadsheet();
    try {
        const result = Common.Modules.JsonStudio.minifyActiveRange(activeSpreadsheet);
